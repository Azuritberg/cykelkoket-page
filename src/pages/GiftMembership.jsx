...
function GiftMembership() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await fetch("/api/send-gift-membership", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          friendEmail: data.get("friendEmail"),
          yourName: data.get("yourName"),
          yourEmail: data.get("yourEmail"),
          welcomeDate: data.get("welcomeDate"),
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "Kunde inte skicka formuläret")
      }
        ...
        <section className="relative overflow-hidden p-6 sm:p-10 md:p-16">
          <div className="relative z-10">
            ...
            <p className="mt-8 max-w-2xl text-base leading-relaxed sm:text-lg">
              Frågar du oss på Cykelköket så är ett medlemskap i Cykelköket
              världens bästa present, oavsett om det är julklapp, namnsdag,
              födelsedag eller att din vän bara är värd något fint. Samtidigt
              vill du inte köpa ännu en sak.
              <br />
              <br />
              Med ett medlemskap i Cykelköket får din vän möjlighet att vara
              med och skapa ett lite bättre Malmö genom fler hela och
              lättrullande cyklar. För vem blir inte lycklig av en nyservad
              lättrullande cykel, när man dessutom gjort det själv!
            </p>

            <p className="mt-8 max-w-2xl text-base leading-relaxed sm:text-lg">
              Om du vill ge bort ett medlemskap i Cykelköket gör du enligt
              stegen nedan:
            </p>


            {submitStatus === "success" ? (
              <div className="flex min-h-[500px] flex-col items-center justify-center px-4 py-16 text-center sm:min-h-[600px]">
                <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[var(--surface-dark)] text-4xl font-black text-white sm:h-24 sm:w-24 sm:text-5xl">
                  ✓
                </div>
                ...
                <p className="mt-6 max-w-xl text-xl leading-relaxed sm:text-2xl">
                  Uppgifterna har skickats till Cykelköket.
                </p>

                <p className="mt-3 max-w-xl text-base leading-relaxed sm:text-lg">
                  Vi kontaktar personen som får medlemskapet med välkomstinformation tidigast det datum du har
                  angett.
                </p>
              </div>
            ) : (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <h2 className="mt-12 max-w-2xl text-2xl font-black uppercase leading-tight sm:text-3xl">
                ...
                <div className="mt-6 max-w-2xl space-y-5">
                  ...
                  <p className="text-base leading-relaxed sm:text-lg">
                    Alla nya medlemmar får ett välkomstmail av oss. För att vi
                    inte ska skicka det innan din vän fått presenten av dig vill
                    vi veta när vi tidigast kan skicka vårt välkomstmail. Skriver
                    du inget datum skickar vi det så snart som möjligt.
                  </p>
                  ...
                  <label className="block">
                    ...
                    <input
                      name="welcomeDate"
                      type="date"
                      className="mt-2 w-full rounded-xl border-2 border-black bg-[var(--surface)] px-4 py-4 text-black"
                    />
                  </label>
                ...
                <p className="mt-4 max-w-2xl text-base leading-relaxed sm:text-lg">
                  ...
                  <br />
                  Om du inte har möjlighet att betala med Swish eller Bankgiro
                  kan du skicka ett mail till oss.
                  <br />
                ...
                <p className="mt-4 max-w-2xl text-base leading-relaxed sm:text-lg">
                  ...
                  <br />
                  Skriv present + namnet på den som ska få medlemskapet.
                </p>
                ...
                <p className="mt-4 max-w-2xl text-base leading-relaxed sm:text-lg">
                  Skriv ut det presentkort du tycker är finast.
                  <br className="hidden md:block" />
                  Eller så gör du ett eget presentkort för lite mer personlig
                  touch.
                </p>
                  ...
                  <div className="flex w-max items-center gap-0">
                    {giftCards.map((card) => (
                      <button
                        ...
                        className={`
                          group relative shrink-0 bg-transparent p-0
                          transition duration-300
                          hover:z-10 hover:-translate-y-2
                          ${
                            selectedCard?.id === card.id
                              ? "z-10 drop-shadow-[0_0_20px_var(--lime)]"
                              : ""
                          }
                        `}
                      >
                        <img
                          ...
                          alt={card.id}
                          className="
                            h-[120px] w-[190px] max-w-none object-cover
                            transition duration-300
                            group-hover:scale-[0.92]
                            group-hover:drop-shadow-[0_0_30px_var(--pink)]
                            sm:h-[150px] sm:w-[240px]
                            md:h-[170px] md:w-[270px]
                            lg:h-[190px] lg:w-[300px]
                          "
                        />
                      </button>
                    ))}
                ...
                {selectedCard && (
                  <p className="mt-6 max-w-2xl font-black">
                    Valt presentkort: {selectedCard.id}
                  </p>
                )}
                ...
                <h2 className="mt-12 max-w-2xl text-2xl font-black uppercase leading-tight sm:text-3xl">
                  4. Skicka uppgifterna
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-relaxed sm:text-lg">
                  Kontrollera att uppgifterna stämmer och skicka sedan formuläret
                  till Cykelköket.
                </p>
                ...
                <button
                  ...
                  className="
                    ...
                    transition
                    hover:-translate-y-1
                    hover:shadow-[0_0_10px_var(--surface-dark)]
                ...
                {submitStatus === "error" && (
                  <p
                    className="mt-6 max-w-2xl font-black"
                    role="alert"
                  >
                    Något gick fel. Försök igen eller kontakta
                    kassor.cykelkoket@gmail.com.
                  </p>
                )}
              </form>
             )}
          ...
          <div className="page-decoration pointer-events-none absolute bottom-0 right-0 hidden h-full w-[40%] overflow-hidden lg:block">
            <img
              src={biker}
              alt=""
              className="absolute bottom-[1000px] right-[-5px] h-[900px] w-auto max-w-none object-contain opacity-30"
            />
          </div>
          ...
          {previewCard && (
            ...
            >
              <div
                className="relative max-h-[90vh] max-w-[95vw] overflow-auto rounded-2xl border border-white/20 bg-white/5 p-4 backdrop-blur-xl"
                onClick={(event) => event.stopPropagation()}
              >
                <img
                  src={previewCard.image}
                  alt={previewCard.id}
                  className="max-h-[70vh] max-w-full rounded-xl object-contain shadow-[0_0_40px_rgba(0,0,0,0.35)] sm:max-h-[75vh]"
                />

                <div className="mt-6 flex flex-wrap justify-center gap-4">
                  <a
                    href={previewCard.image}
                    download
                    className="rounded-xl bg-[var(--pink)] px-6 py-4 text-sm font-black uppercase text-black transition hover:-translate-y-1 hover:shadow-[0_0_10px_var(--pink)] sm:px-7 sm:text-base"
                  >
                    Ladda ner
                  </a>
                  ...
                  <button
                    type="button"
                    onClick={() => setPreviewCard(null)}
                    className="rounded-xl border-2 border-white px-6 py-4 text-sm font-black uppercase text-white transition hover:bg-white hover:text-black sm:px-7 sm:text-base"
                  >
                    Stäng
                  </button>
                </div>
